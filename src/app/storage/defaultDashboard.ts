  ...
  "widgets": [
    {
      ...
      "config": {
        ...
        "displayOrder": ["position", "carNumber", "countryFlags", "driverName", "pitStatus", "carManufacturer", "badge", "positionChange", "gap", "interval", "fastestTime", "lastTime", "compound", "lapTimeDeltas"]
      }
    },
    {
      "id": "input",
